...
import OcrLoadingScreen from '../../../_components/OcrLoadingScreen';
...
export default function RulingUploadPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      router.push(`/appeal/${caseNo}/ruling/analysis`);
    } catch (err) {
      setPageStep('form');
      console.log(err);
