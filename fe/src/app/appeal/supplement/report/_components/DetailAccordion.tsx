...
import { Reason, Evidence, MainPoint } from '../types';
...
export default function DetailAccordion({ reasons, evidences, mainPoints }: DetailAccordionProps) {
