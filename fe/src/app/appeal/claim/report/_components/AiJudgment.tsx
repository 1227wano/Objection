...
export default function AiJudgment({ summation, label = 'AI 판단' }: AiJudgmentProps) {
  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm flex items-start gap-4">
      ...
      <div className="flex-1 min-w-0 pt-0.5">
        ...
        <p className="text-gray-800 text-[16px] leading-relaxed whitespace-pre-wrap">{summation}</p>
      </div>
    </div>
  );
}
